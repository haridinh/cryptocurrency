...
var themePrimaryColor = secondaryColor;
...
const successColor = Color.fromRGBO(0, 128, 0, 1.0);
const lightModePrimaryColor = Color(0xFFFFFFFF);
const lightModeCardColor = Color(0xFFFFFFFF);
