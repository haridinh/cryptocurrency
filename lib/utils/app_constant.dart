...
class AppConstant {
  ...
  static CurrencyModel defaultCurrency = CurrencyModel(
    name: 'United Kingdom',
    cc: 'gbp',
    symbol: '£',
  );

  static const isAdsLoading = true;
}
...
class Admob {
  static String mAdMobBannerId = '';
  static String mAdMobInterstitialId = '';
}
...
class SharedPreferenceKeys {
  ...
  static const SORTING_CATEGORIES_SELECTED_INDEX =
      "SORTING_CATEGORIES_SELECTED_INDEX";
  static const DEFAULT_INTERVAL_SELECTED_INDEX =
      "DEFAULT_INTERVAL_SELECTED_INDEX";
...
class AppImages {
  static const walkThroughBackgroundImg =
      "images/app_images/walkthrough_background.jpg";
  ...
  static const gifWithoutWhiteName =
      "images/app_images/loader_logo_white_gif.gif";
  ...
  static const candle_stick_chart =
      "images/chart_images/candle_stick_chart.jpg";
...
class Urls {
  ...
  static const copyRight = 'copyright @2023 IQONIC Design';
  ...
  static const documentation =
      'https://wordpress.iqonic.design/docs/product/cryptocoins/';
}

class IqonicUrls {
  static const Website = "https://iqonic.design/";
  static const Themeforest =
      "https://themeforest.net/user/iqonicdesign/portfolio";
  static const Codecanyon =
      "https://codecanyon.net/user/iqonicdesign/portfolio";
