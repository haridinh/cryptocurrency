// Các tiêu chí sắp xếp tiền điện tử
...
class SortingTypeModel {
  ...
  static List<SortingTypeModel> get getSortingTypeList {
    ...
    data.add(
      SortingTypeModel(
        id: 6,
        name: "Largest Positive price % change",
        value: "id_desc",
      ),
    );
    data.add(
      SortingTypeModel(
        id: 7,
        name: "Largest Negative price % change",
        value: "id_asc",
      ),
    );
    return data;
  ...
  static List<SortingTypeModel> get getCategorySortingTypeList {
    ...
    data.add(
      SortingTypeModel(
        id: 0,
        name: "Largest Market Cap(Default)",
        value: "market_cap_desc",
      ),
    );
    data.add(
...
SortingTypeModel? getSelectedSortingType({int defaultOrder = 3}) {
  ...
  for (var element in SortingTypeModel.getSortingTypeList) {
    if (element.id ==
        getIntAsync(
...
SortingTypeModel? getSelectedCategoriesSortingType({int defaultOrder = 0}) {
  ...
  for (var element in SortingTypeModel.getCategorySortingTypeList) {
    if (element.id ==
        getIntAsync(
...
SortingTypeModel? getSelectedSortingIntervalType({int defaultInterval = 0}) {
  ...
  for (var element in SortingTypeModel.getSortingIntervalList) {
    if (element.id ==
        getIntAsync(
          SharedPreferenceKeys.DEFAULT_INTERVAL_SELECTED_INDEX,
