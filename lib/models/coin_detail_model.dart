// Tất cả thông tin chi tiết về một đồng coin
...
class CoinDetailModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['asset_platform_id'] = asset_platform_id;
    data['block_time_in_minutes'] = block_time_in_minutes;
    data['coingecko_rank'] = coingecko_rank;
    data['coingecko_score'] = coingecko_score;
    data['community_score'] = community_score;
    data['country_origin'] = country_origin;
    data['developer_score'] = developer_score;
    data['genesis_date'] = genesis_date;
    ...
    data['name'] = name;
    data['public_numerest_score'] = public_numerest_score;
    data['public_notice'] = public_notice;
    data['sentiment_votes_down_percentage'] = sentiment_votes_down_percentage;
    data['sentiment_votes_up_percentage'] = sentiment_votes_up_percentage;
    data['symbol'] = symbol;
    ...
    if (community_data != null) {
      data['community_data'] = community_data!.toJson();
    }
    if (description != null) {
      data['description'] = description!.toJson();
    }
    if (developer_data != null) {
      data['developer_data'] = developer_data!.toJson();
    }
    if (image != null) {
    ...
    if (market_data != null) {
      data['market_data'] = market_data!.toJson();
    }
    if (platforms != null) {
      data['platforms'] = platforms!.toJson();
    }
    if (public_numerest_stats != null) {
      data['public_numerest_stats'] = public_numerest_stats!.toJson();
    }
...
class PublicnumerestStats {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['bing_matches'] = bing_matches;
    return data;
  }
}
...
class Links {
  ...
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    data['bitconumalk_thread_identifier'] = bitconumalk_thread_identifier;
    data['facebook_username'] = facebook_username;
    data['subreddit_url'] = subreddit_url;
    data['telegram_channel_identifier'] = telegram_channel_identifier;
    data['twitter_screen_name'] = twitter_screen_name;
    if (announcement_url != null) {
      data['announcement_url'] = announcement_url;
    }
    if (blockchain_site != null) {
      data['blockchain_site'] = blockchain_site;
    }
    if (chat_url != null) {
    ...
    if (official_forum_url != null) {
      data['official_forum_url'] = official_forum_url;
    }
    if (repos_url != null) {
      data['repos_url'] = repos_url!.toJson();
    }
    return data;
  }
}
...
class MarketData {
  ...
  factory MarketData.fromJson(Map<String, dynamic> json) {
    return MarketData(
      ...
      ath_date: json['ath_date'] != null
          ? AthDate.fromJson(json['ath_date'])
          : null,
      atl: json['atl'] != null
      ...
      atl_date: json['atl_date'] != null
          ? AthDate.fromJson(json['atl_date'])
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    data['fdv_to_tvl_ratio'] = fdv_to_tvl_ratio;
    data['last_updated'] = last_updated;
    data['market_cap_change_24h'] = market_cap_change_24h;
    data['market_cap_change_percentage_24h'] = market_cap_change_percentage_24h;
    data['market_cap_rank'] = market_cap_rank;
    data['max_supply'] = max_supply;
    data['mcap_to_tvl_ratio'] = mcap_to_tvl_ratio;
    data['price_change_24h'] = price_change_24h;
    data['price_change_percentage_14d'] = price_change_percentage_14d;
    data['price_change_percentage_1y'] = price_change_percentage_1y;
    data['price_change_percentage_200d'] = price_change_percentage_200d;
    data['price_change_percentage_24h'] = price_change_percentage_24h;
    data['price_change_percentage_30d'] = price_change_percentage_30d;
    data['price_change_percentage_60d'] = price_change_percentage_60d;
    data['price_change_percentage_7d'] = price_change_percentage_7d;
    data['roi'] = roi;
    ...
    if (ath_change_percentage != null) {
      data['ath_change_percentage'] = ath_change_percentage!.toJson();
    }
    if (ath_date != null) {
      data['ath_date'] = ath_date!.toJson();
    }
    if (atl != null) {
      data['atl'] = atl!.toJson();
    }
    if (atl_change_percentage != null) {
      data['atl_change_percentage'] = atl_change_percentage!.toJson();
    }
    if (atl_date != null) {
      data['atl_date'] = atl_date!.toJson();
    }
    if (current_price != null) {
      data['current_price'] = current_price!.toJson();
    }
    if (fully_diluted_valuation != null) {
      data['fully_diluted_valuation'] = fully_diluted_valuation!.toJson();
    }
    if (high_24h != null) {
      data['high_24h'] = high_24h!.toJson();
    }
    if (low_24h != null) {
      data['low_24h'] = low_24h!.toJson();
    }
    if (market_cap != null) {
      data['market_cap'] = market_cap!.toJson();
    }
    if (market_cap_change_24h_in_currency != null) {
      data['market_cap_change_24h_in_currency'] =
          market_cap_change_24h_in_currency!.toJson();
    }
    if (market_cap_change_percentage_24h_in_currency != null) {
      data['market_cap_change_percentage_24h_in_currency'] =
          market_cap_change_percentage_24h_in_currency!.toJson();
    }
    if (price_change_24h_in_currency != null) {
      data['price_change_24h_in_currency'] = price_change_24h_in_currency!
          .toJson();
    }
    if (price_change_percentage_14d_in_currency != null) {
      data['price_change_percentage_14d_in_currency'] =
          price_change_percentage_14d_in_currency!.toJson();
    }
    if (price_change_percentage_1h_in_currency != null) {
      data['price_change_percentage_1h_in_currency'] =
          price_change_percentage_1h_in_currency!.toJson();
    }
    if (price_change_percentage_1y_in_currency != null) {
      data['price_change_percentage_1y_in_currency'] =
          price_change_percentage_1y_in_currency!.toJson();
    }
    if (price_change_percentage_200d_in_currency != null) {
      data['price_change_percentage_200d_in_currency'] =
          price_change_percentage_200d_in_currency!.toJson();
    }
    if (price_change_percentage_24h_in_currency != null) {
      data['price_change_percentage_24h_in_currency'] =
          price_change_percentage_24h_in_currency!.toJson();
    }
    if (price_change_percentage_30d_in_currency != null) {
      data['price_change_percentage_30d_in_currency'] =
          price_change_percentage_30d_in_currency!.toJson();
    }
    if (price_change_percentage_60d_in_currency != null) {
      data['price_change_percentage_60d_in_currency'] =
          price_change_percentage_60d_in_currency!.toJson();
    }
    if (price_change_percentage_7d_in_currency != null) {
      data['price_change_percentage_7d_in_currency'] =
          price_change_percentage_7d_in_currency!.toJson();
    }
    if (sparkline_7d != null) {
      data['sparkline_7d'] = sparkline_7d!.toJson();
    }
    if (total_volume != null) {
      data['total_volume'] = total_volume!.toJson();
    }
    return data;
  }
}
...
class DeveloperData {
  ...
  factory DeveloperData.fromJson(Map<String, dynamic> json) {
    return DeveloperData(
      ...
      last_4_weeks_commit_activity_series:
          ...
          ? List<num>.from(json['last_4_weeks_commit_activity_series'])
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    data['commit_count_4_weeks'] = commit_count_4_weeks;
    data['forks'] = forks;
    data['pull_request_contributors'] = pull_request_contributors;
    data['pull_requests_merged'] = pull_requests_merged;
    data['stars'] = stars;
    data['subscribers'] = subscribers;
    data['total_issues'] = total_issues;
    if (code_additions_deletions_4_weeks != null) {
      data['code_additions_deletions_4_weeks'] =
          code_additions_deletions_4_weeks!.toJson();
    }
    if (last_4_weeks_commit_activity_series != null) {
...
class Platforms {
  ...
  factory Platforms.fromJson(Map<String, dynamic> json) {
    return Platforms(string: json['String']);
  }
...
class CommunityData {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['reddit_accounts_active_48h'] = reddit_accounts_active_48h;
    data['reddit_average_comments_48h'] = reddit_average_comments_48h;
    data['reddit_average_posts_48h'] = reddit_average_posts_48h;
    data['reddit_subscribers'] = reddit_subscribers;
    data['telegram_channel_user_count'] = telegram_channel_user_count;
...
class Ticker {
  ...
  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    data['base'] = base;
    data['bid_ask_spread_percentage'] = bid_ask_spread_percentage;
    data['coin_id'] = coin_id;
    data['is_anomaly'] = is_anomaly;
    data['is_stale'] = is_stale;
    data['last'] = last;
    data['last_fetch_at'] = last_fetch_at;
    data['last_traded_at'] = last_traded_at;
    data['target'] = target;
    data['target_coin_id'] = target_coin_id;
    data['timestamp'] = timestamp;
    data['token_info_url'] = token_info_url;
